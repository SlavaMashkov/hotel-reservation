...
type RoomStore interface {
	...
	GetRooms(ctx context.Context, query *types.QueryRoomParams) ([]*types.Room, error)
}
...
func (store *MongoRoomStore) GetRooms(ctx context.Context, query *types.QueryRoomParams) ([]*types.Room, error) {
	filter := query.ToBSON()
